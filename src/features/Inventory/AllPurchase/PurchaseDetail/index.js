...
import { EnvelopeIcon, DocumentTextIcon, PrinterIcon, ChatBubbleLeftEllipsisIcon } from '@heroicons/react/24/outline';
      ...
      <div className="bg-base-100 p-6 rounded-2xl shadow-lg">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-center w-full">
            <h2 className="text-lg font-bold">Purchases Detail: PR_0012</h2>
            <div className="flex space-x-2">
              ...
              <IconButton
                ...
                label="SMS"
                onClick={() => { }}
                className="btn btn-outline btn-success flex items-center text-sm h-10 text-green-500 border-green-500 hover:bg-green-100"
              />
              {/* PDF Button */}
              <IconButton
              ...
              <IconButton
                ...
                label="Print"
                onClick={() => { }}
                className="btn btn-outline btn-primary flex items-center text-sm h-10 text-blue-500 border-blue-500 hover:bg-blue-100"
              />
            </div>
          </div>
        ...
        <div className="flex justify-end mt-6 space-y-2">
          <div className="text-sm text-right w-72">
            <div className="bg-gray-300 border-t border-b border-black p-2 flex text-neutral justify-between">
              <span>Order Tax:</span> <span className="font-bold">$0.00 (0.00%)</span>
            </div>
            <div className="p-2 flex justify-between">
              <span>Discount:</span> <span className="font-bold">$0.00</span>
            </div>
            <div className="bg-gray-300 border-t border-b border-black p-2 flex text-neutral justify-between">
              <span>Shipping:</span> <span className="font-bold">$0.00</span>
            </div>
            <div className="p-2 flex justify-between font-bold">
              <span>Grand Total:</span> <span>$1736.00</span>
            </div>
            <div className="bg-gray-300 border-t border-b border-black p-2 flex text-neutral justify-between  font-bold">
              <span>Paid:</span> <span className="font-bold">$0.00</span>
            </div>
            <div className="p-2 flex justify-between">
              <span>Due:</span> <span>$1736.00</span>
            </div>
          </div>
        </div>
