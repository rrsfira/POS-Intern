...
const EditReturnPurchase = () => {
  ...
  const [orderTax, setOrderTax] = useState(2.5);
  const [discount, setDiscount] = useState(3.0);
  ...
  // Calculate totals from the dummy data
  const totalSubtotal = orderItems.reduce(
    (total, item) => total + item.subtotal,
    0
  );
  const total = totalSubtotal + orderTax - discount + shipping;

  return (
    <TitleCard title="Return Edit Purchase" topMargin="mt-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <option value="PR_123">PR_123</option>
            <option value="PR_321">PR_321</option>
          </select>
        </div>
